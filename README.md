...
- GTS passport appointment monitoring is marked Beta and is bound to a CEAC profile. It polls about every 1-30 minutes during normal hours, with separate switches for automatic polling and slot-change email notifications. It only detects and notifies; it does not auto-book, hold, or grab slots. Once slots are found, polling slows to roughly once per hour until the user confirms they have booked and stops monitoring.
