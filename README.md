...
- GTS passport appointment monitoring is bound to a CEAC profile. It polls about every 30 minutes during normal hours, with separate switches for automatic polling and slot-change email notifications. Once slots are found, polling slows to roughly once per hour until the user confirms they have booked and stops monitoring.
